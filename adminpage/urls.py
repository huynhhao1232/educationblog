...
urlpatterns = [
    ...
    path('admission/campus-shift-group/', views.campus_shift_group_manage, name='campus_shift_group_manage'),
    path('admission/vocational-config/', views.admission_vocational_manage, name='admission_vocational_manage'),
    path('admission/delete-all/', views.delete_all_admissions, name='delete_all_admissions'),
    path('admission/', views.get_Admission, name="admission"),
    path('letter/<int:admission_id>/', views.get_Letter, name="letter"),
    path('letter/<int:admission_id>/download-docx/', views.download_admission_docx, name='download_admission_docx'),
